 ...
 *
 */
public class FamousBookActivity extends BaseActivity implements OnClickListener{

	private FamousBookFragmentAdapter adapter;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv_title.setText(getResources().getString(R.string.famous_book));
	}
	private void initView(){
		adapter = new FamousBookFragmentAdapter(getSupportFragmentManager(), this);
